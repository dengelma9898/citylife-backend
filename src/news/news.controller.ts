...
export class NewsController {
  ...
  @Post('text')
  public async createTextNews(@Body() createTextNewsDto: CreateTextNewsDto): Promise<TextNewsItem> {
  ...
  @Post('poll')
  public async createPollNews(@Body() createPollNewsDto: CreatePollNewsDto): Promise<PollNewsItem> {
